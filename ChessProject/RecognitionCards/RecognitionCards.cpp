...
/*参数*/
double minTh = 0.1;//小牌阀值
double maxTh = 0.06;//大牌阀值
double stTh = 0.06;//大牌阀值
int aroundPix = 30;//单张像素值
int x = 0, y = 30;//整图距屏幕右上角距离
...
int main()
{
	...
	string temp = "E:\\SVN\\CShap\\trunk\\ChessProject\\img\\1024\\temp1";//打出牌识别模版
	string temp2 = "E:\\SVN\\CShap\\trunk\\ChessProject\\img\\1024\\temp2";//手中牌模版
	string temp3 = "E:\\SVN\\CShap\\trunk\\ChessProject\\img\\1024\\start.png";//手中牌模版
	//2、加载模版文件到内存
	...
	//bool isGetHandlesCards = false;//是否获取手中的排
	while (true)
	{
		//开始计时
		...
		//判断是否重新开始
		//Mat stIMg = Mat(gary, st);
		//bool isStart = helper.HaveTemp(stIMg, temp3, stTh);
		//if (isStart)
		//{
		//	isGetHandlesCards = true;
		//	helper.InitCards();
		//	helper.outputStr = "";
		//}
		//stIMg.release();
		//if (isGetHandlesCards)
		//{
